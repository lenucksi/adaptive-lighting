...
| `light_calibration`            | Per-light calibration offsets for color temperature. Dict with light_entity_id → {anchor_a_temp, anchor_a_offset, anchor_b_temp, anchor_b_offset}. 🔧                                                                                                                                                                                                                                         | `{}`           | dict                                    |
